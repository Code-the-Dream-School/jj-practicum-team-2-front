                        ...
                        <div className="grid gap-4 mb-4 grid-cols-2">
                            <div className="col-span-2">
                                ...
                                <input
                                    ...
                                    className="bg-gray-100 border border-gray-300 text-black placeholder-gray-400 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <select
                                    ...
                                    value={form.type}
                                    onChange={handleChange}
                                    className="bg-gray-100 border border-gray-300 text-black placeholder-gray-400 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5"
                                    required
                                >
