...
import { ExclamationTriangleIcon, CheckCircleIcon, PencilIcon } from '@heroicons/react/24/solid';
...
export default function WeeklyGoalIndicator({ 
  ...
  const progressPercentage = Math.min((attendedSessions / weeklyGoal) * 100, 100);
  ...
  const handleInputChange = (e) => {
    ...
    if (numValue >= 0 && numValue <= 99) { // Reasonable upper limit for typing
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-3">
            <div className={`w-3 h-3 rounded-full ${goalMet ? 'bg-green-500' : 'bg-yellow-500'}`}></div>
