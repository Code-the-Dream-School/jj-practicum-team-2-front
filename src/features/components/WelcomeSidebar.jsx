...
const WelcomeSidebar = () => {
    return (
        <div className="w-full lg:w-1/2 bg-blue-900 text-white flex flex-col justify-center items-center h-64 lg:h-screen p-8" style={{
            background: ' #384A68',
        }}>
            <div >
                <span className='flex justify-center'> <img className="h-20 w-20 object-scale-down " src={logo} alt="logo" /> </span>
